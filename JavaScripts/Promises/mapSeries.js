...
// Implement a mapSeries async function that is similar to the Array.map() 
// but returns a promise that resolves on the list of output by 
// mapping each input through an asynchronous iteratee function or 
// rejects it if any error occurs. The inputs are run in a sequence that is one after another.
